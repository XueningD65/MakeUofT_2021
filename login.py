...
def register():
    ...
    c_1 = tk.Radiobutton(reg_window, text="Student", variable=entry_type, value="Student").grid(row=4, column=0)
    c_2 = tk.Radiobutton(reg_window, text="Staff", variable=entry_type, value="Staff").grid(row=4, column=1)
...
button_1 = tk.Button(login,text="Log in",width=10,command=call_back).grid(row=4,column=0,sticky=tk.W,padx=10,pady=5)
button_2 = tk.Button(login,text="Register",width=10,command=register).grid(row=4,column=1,sticky=tk.E,padx=10,pady=5)
choose_1 = tk.Radiobutton(login, text="Student", variable=ty, value="Student").grid(row=3,column=0)
choose_2 = tk.Radiobutton(login, text="Staff", variable=ty, value="Staff").grid(row=3,column=1)
