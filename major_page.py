...
def create(name,login):
    ...
    class major(tk.Tk):
        def __init__(self, *args, **kwargs):
            ...
            for F in (page1, serial_page, potentiometer_page, PageOne, PageTwo, PageThree):
    ...
    class page1(tk.Frame):
        def __init__(self, parent, controller):
            ...
            img_but = tk.Button(self, text="image", command=lambda: controller.show_frame(serial_page))
